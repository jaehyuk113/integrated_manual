...
| `identification_card`              | An offical document issued by a U.S. state government and is used within U.S. to verify the holder’s identity and nationality. It is used only for U.S. and is presented to users as a State ID. |