...
description: Detailed guide on request quotas, types of limits, and procedures for increasing API rate limits for the ID Check API.
---
...
<Info>
The current API usage quotas for the ID Check API are as follows and are subject to change.
</Info>
