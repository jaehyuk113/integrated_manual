...
| `projection.projectionId`              | The projection ID into applied submission                                                                                                                       | String    | Projection Info        |
| `projection.projectionName`            | Applied submission projection ID                                                                                                                                | String    | Projection Info        |
