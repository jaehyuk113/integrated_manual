...
<ResponseField name="ipRiskDurationHours" type="int">
  **Must be encrypted.** If the system detects risk, set the hour and how many hours to restrict. If `ipRiskCategory` is set without `ipRiskDurationHours`, It must be used with `ipRiskCategory`.
</ResponseField>
...
```json result.json
{
    ...
    "action": {
        "type": "address",
        "created_at": "2025-05-13T04:01:20.944Z"
    },
    "submission_id": "19g6im9gk9e7l",
    "email": "webhook041413@test.com",
    "kyc_status": "approved",
    "applicant_id": "mgm8m8mjicls"
}
```
