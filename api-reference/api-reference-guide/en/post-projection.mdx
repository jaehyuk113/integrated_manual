...
<Note>
  ...
  For details, refer to [key query string parameters](https://developers.argosidentity.com/getting-started/en/liveform-url/querystring-and-token-guide#2-1-key-query-string-parameters) sections
</Note>
...
<ResponseField name="fields" type="array" required>
  ...
  - `mid_name` The middle name that was submitted
