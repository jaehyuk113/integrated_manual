...
- [Global ID Recognition](https://dev.argosidentity.com/verify-id/global-id-recognition/global-id-recognition-api-1)
- [ID Liveness](https://dev.argosidentity.com/verify-id/id-liveness/id-liveness-api-1)
- [Face Compare](https://dev.argosidentity.com/verify-id/face-compare/face-compare-api-1)
...
<Update label="2024-11-05" description="v1.0.0">
 ## New features
[Textify API](https://dev.argosidentity.com/verify/textify/introduction) is now available, allowing you to automate data extraction and streamline document workflows like never before. Now supported in US region, Textify empowers teams with easy access to critical document data.
 ## ✨ NEW Templatesto Meet Every Need
