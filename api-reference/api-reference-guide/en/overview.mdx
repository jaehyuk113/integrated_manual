...
If your goal is to provide API-based services to clients, ARGOS is willing to provide support for integration and connectivity. For more detailed information, please refer to the [Verify Getting Started page](/getting-started/en/introduction).
</Warning>
