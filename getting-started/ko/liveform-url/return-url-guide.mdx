...
Dashboard 에선 리턴 URL 옵션을 설정하실 수 있습니다. KYC 프로세스가 완료되고, 제출자가 "Ok" 버튼 선택시에 혹은 5초간 대기 후에, 동적 필드의 파라미터와 함께 리턴 URL의 주소로 이동됩니다. 최종 리턴 URL 이 바로 "Ok" 버튼을 선택했을 시의 URL 입니다.
