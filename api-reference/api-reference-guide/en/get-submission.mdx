---
title: "GET/Submission (Bulk as list)"
...
<Note>
  This method is for a **bulk** entity; if you are in search of a singular entity method, please refer to this [link](https://developers.argosidentity.com/api-reference/api-reference-guide/en/get-submission/submissionId).
</Note>
