...
<Update label="2025-06-26">
  ## Textify Auto Parser API Release

   Textify Auto Parser API has been added! It automatically extracts structured data from government ID documents, eliminating manual data entry and accelerating identity verification workflows.
