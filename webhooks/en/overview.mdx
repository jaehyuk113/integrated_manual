...
<img height="500" src="/images/webhooks/webhook_events.png" />
 <CardGroup cols={4}>
  <Card title="Approved" icon="badge-check" href="/webhooks/en/idcheck-approved"></Card> 
  <Card title="Rejected" icon="ban" href="/webhooks/en/idcheck-rejected"></Card>
  <Card title="Updated" icon="pen-to-square" href="/webhooks/en/idcheck-updated"></Card>
  <Card title="Delete" icon="trash" href="/webhooks/en/idcheck-delete"></Card>
  <Card title="Submit" icon="plus" href="/webhooks/en/idcheck-submit"></Card> 
  <Card title="Data injection" icon="table" href="/webhooks/en/idcheck-injection"> </Card>
  <Card title="AML Result" icon="radar" href="/webhooks/en/idcheck-aml-result"> </Card> 
 </CardGroup> 
