...
<Note>Pre-requisite: You must enable the secure encryption option. Before applying encryption, please review the [guide](/getting-started/en/encrypt-and-decrpyt-data/overview#3-secure-data-transmission-options) first. </Note>
