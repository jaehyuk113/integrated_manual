---
title: "GET/Submission (다수 건 목록)"
description: "이 API를 사용하면 제출된 ID Check 데이터를 조회할 수 있습니다. 특정 제출 건의 상세 정보를 확인하거나 여러 제출 건의 목록을 필터링하여 가져올 수 있습니다."
---

<Note>
  본 메소드는 **다수**의 목록을 가져옵니다. 단일 건만 가저오는 메소드 호출 방법은 [여기](https://developers.argosidentity.com/api-reference/api-reference-guide/ko/get-submission/submissionId)를 참조해주세요.
</Note>
