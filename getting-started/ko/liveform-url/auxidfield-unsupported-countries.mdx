---
mode: "default"
title: "auxidField SMS 인증 미지원 국가 목록"
description: "auxidField phoneNumber 기능에서 SMS 인증을 지원하지 않는 91개 국가의 상세 목록입니다."
---

# auxidField SMS 인증 미지원 국가 목록

auxidField의 phoneNumber 기능은 현재 **91개 국가**에서 SMS 인증을 지원하지 않습니다.
...
<AccordionGroup>
  ...
  <Accordion title="Oceania (오세아니아) - 1개국" icon="globe">
    - New Zealand (+64)
  </Accordion>
</AccordionGroup>
