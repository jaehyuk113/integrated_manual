...
<ResponseField name="issuingCountry" type="string" required="true">
  Issuing country of the ID [Country Codes](/api-reference/api-reference-guide/en/iso-alpha-3-country-codes).
</ResponseField>

<ResponseField name="nationality" type="string">
  Nationality of the KYC submitter [Country Codes](/api-reference/api-reference-guide/en/iso-alpha-3-country-codes).
</ResponseField>
