...
<Note>AML 스크리닝은 KYC 승인 후에만 수행됩니다. KYC가 승인된 경우에만 AML 스크리닝이 진행되며, 그 결과와 함께 submission 정보가 반환됩니다. KYC가 거절된 경우에는 AML 스크리닝이 수행되지 않습니다.</Note>
...
<ResponseField name="aml_result" type="object">
  ...
  <Expandable title="properties">
    ...
    <ResponseField name="risk_level_summary" type="boolean">
