...
- Custom API 키키: 라이브폼에서 신규로 발급받아 사용하는 secretKey
![Encryption modules](manual-idcheck/images/encryption_modules/encryption_kr.png)
...
<Steps>
  ...
  <Step title="암호화 모듈 AES-256/GCM-256 및 API 키 및 secretKey 중 하나를 선택">
    <img
      height="200"
      src="/images/encryption_modules/encryption_kr.png"
    />
    <Note>
