...
<Info>
  **지원되지 않는 국가 확인**
  ...
  auxidField phoneNumber 기능에서 SMS 인증을 지원하지 않는 91개 국가의 상세 목록을 확인하려면 아래 링크를 참조하세요.
  
  📋 [**SMS 인증 미지원 국가 목록 보기**](/getting-started/ko/liveform-url/auxidfield-unsupported-countries)
</Info>
