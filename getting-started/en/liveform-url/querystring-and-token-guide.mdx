...
| `allowedCountries`  \* only encrypted support    | Yes         | Yes             | `allowedCountries` can only be set using the encryption option and cannot be specified directly. e.g., If the encrypted value `{'allowedCountries': 'USA,KOR'}` is provided, only the United States (USA) and South Korea (KOR) will be allowed.  - In Knowledge-Based, if `allowedCountries` set one nationality, e.g. `{'allowedCountries': 'USA'}` The form skips to the select country page. |
| `knowledgeField`       \* only encrypted support | No          | Yes             | Set visible fields from the supported fields. Refer to the value below each parameter.                                                                                                                                                                                                                                                                                                           |
| `knowledgePrefill`  \* only encrypted support    | No          | Yes             | Fill out the value in advance. Refer to the value below each parameter.                                                                                                                                                                                                                                                                                                                          |
